...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <!-- Logo -->
        <a class="navbar-brand pt-0" href="/petugas/main_petugas">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <!-- Form -->
            <form class="mt-4 mb-3 d-md-none" action="/petugas/main_petugas" method="GET" id="cari">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="/petugas/main_petugas">
                        <i class="ni ni-tv-2 text-primary"></i> Data Konfirmasi
                    </a>
                </li>
            </ul>
        </div>
...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="/petugas/main_petugas">Home</a>
            <!-- Form -->
            <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto"
                  action="/petugas/main_petugas" method="GET" id="cari">
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Konfirmasi Pemesanan</h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @foreach($pemesanan as $p)
                                <tr>
                                    ...
                                    <td>{{ $p->status }}</td>
                                    <td>
                                        <a href="main_petugas/petugas_konfirmasi/{{ $p->id_pemesanan }}">Konfirmasi</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>

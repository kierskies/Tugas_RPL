            ...
            <div class="col-xl-6 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <!-- Projects table -->
                        @foreach($film as $f)
                            <form action="/admin/main_film/film_update" method="post">
                                <table class="table align-items-center table-flush">
                                    {{ csrf_field() }}

                                    <tr>
                                        <td>ID Film</td>
                                        <td><input name="id" class="form-control" value="{{ $f->id_film }}" readonly
                                                   style="border: none"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Film</td>
                                        <td><input type="text" class="form-control" required="required" name="namafilm"
                                                   value="{{ $f->judul }}"></td>
                                    </tr>
                                    <tr>
                                        <td>Sinopsis</td>
                                        <td><textarea required="required" class="form-control" name="sinopsis"
                                                      style="resize: none;">{{ $f->sinopsis }}</textarea></td>
                                    </tr>
                                    <tr>
                                        <td>Poster</td>
                                        <td><input type="text" class="form-control" name="poster" required="required"
                                                   value="{{ $f->poster_film }}"/></td>
                                    </tr>
                                    <tr>

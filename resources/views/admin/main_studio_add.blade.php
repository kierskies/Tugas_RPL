            ...
            <div class="col-xl-6 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <!-- Projects table -->
                        <form action="/admin/main_studio/studio_storedata" method="post" enctype="multipart/form-data">
                            <table class="table align-items-center table-flush">
                                {{ csrf_field() }}

                                <tr>
                                    <td>ID Studio</td>
                                    <td><input type="text" class="form-control" name="idstudio" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td>No Studio</td>
                                    <td><input type="text" class="form-control" name="nostudio" required="required">
                                    </td>
                                </tr>
                                <tr>

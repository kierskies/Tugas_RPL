                        ...
                        @foreach($studio as $s)
                            <form action="/admin/main_studio/studio_update" method="post">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tr>
                                        <td>ID Studio</td>
                                        <td><input readonly class="form-control" name="idstudio"
                                                   value="{{ $s->id_studio }}"></td>
                                    </tr>
                                    <tr>
                                        <td>No Studio</td>
                                        <td><input type="text" class="form-control" required="required" name="nostudio"
                                                   value="{{ $s->no_studio }}"></td>
                                    </tr>
                                    <tr>

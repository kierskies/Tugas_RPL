            ...
            <div class="col-xl-6 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <!-- Projects table -->
                        <form action="/admin/main_kursi/kursi_storedata" method="post" enctype="multipart/form-data">
                            <table class="table align-items-center table-flush">
                                {{ csrf_field() }}

                                <tr>
                                    <td>ID Kursi</td>
                                    <td><input type="text" class="form-control" name="idkursi" required="required"></td>
                                </tr>
                                <tr>
                                    <td>No Kursi</td>
                                    <td><input type="text" class="form-control" name="nokursi" required="required"></td>
                                </tr>
                                <tr>
                                    <td>Status Kursi</td>
                                    <td>
                                        <select name="status_kursi" class="form-control">

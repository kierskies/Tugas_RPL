...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="/admin/main_film">Dashboard</a>
            <!-- User -->
                        ...
                        @foreach($kategori as $kat)
                            <form action="/admin/main_kategori/kategori_update" method="post">
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tr>
                                        <td>ID Kategori</td>
                                        <td><input readonly class="form-control" name="idkategori"
                                                   value="{{ $kat->id_kategori }}"></td>
                                    </tr>
                                    <tr>
                                        <td>Judul</td>

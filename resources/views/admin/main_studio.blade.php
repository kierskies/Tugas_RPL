...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <!-- Form -->
            <form class="mt-4 mb-3 d-md-none" action="/admin/main_studio" method="GET" id="cari">
                <div class="input-group input-group-rounded input-group-merge">
                    <input class="form-control" name="cari" placeholder="Cari studio" type="text"
                           value="{{ old('cari') }}">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            ...
            <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto"
                  action="/admin/main_studio" method="GET" id="cari">
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Studio List</h3>
                            </div>
                            <div class="col text-right">
                                <a href="/admin/main_studio/studio_add" class="btn btn-sm btn-primary">Tambah Data</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @foreach($studio as $s)
                                <tr>
                                    <th align="center">{{ $s->id_studio }}</th>
                                    <td >{{ $s->no_studio }}</td>
                                    <td align="center">
                                        <a href="/admin/main_studio/studio_edit/{{ $s->id_studio }}">Edit</a>
                                        |
                                        <a href="/admin/main_studio/studio_delete/{{ $s->id_studio }}">Hapus</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>

            ...
            <div class="col-xl-6 mb-5 mb-xl-0">
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        ...
                        <form action="/admin/main_jadwal/jadwal_storedata" method="post" enctype="multipart/form-data">
                            <table class="table align-items-center table-flush">
                                {{ csrf_field() }}

                                <tr>
                                    <td>ID Jadwal</td>
                                    <td><input type="text" name="id_jadwal" class="form-control" required="required">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Nama Film</td>
                                    <td>
                                        <select name="id_film" class="form-control">
                                            ...
                                            @foreach($film as $j)
                                                <option value="{{ $j->id_film }}">{{ $j->judul }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Jam Tayang</td>
                                    <td><input type="text" name="jam_tayang" class="form-control" placeholder="--:--"
                                               required="required"></td>
                                </tr>
                                <tr>
                                    <td>Tanggal</td>
                                    <td><input type="text" name="tanggal" class="form-control" placeholder="YYYY/MM/DD"
                                               required="required"></td>
                                </tr>
                                <tr>

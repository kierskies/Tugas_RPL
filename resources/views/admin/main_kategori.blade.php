...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <!-- Form -->
            <form class="mt-4 mb-3 d-md-none" action="/admin/main_kategori" method="GET" id="cari">
                <div class="input-group input-group-rounded input-group-merge">
                    <input class="form-control" name="cari" placeholder="Cari kategori film" type="text"
                           value="{{ old('cari') }}">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            ...
            <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto"
                  action="/admin/main_kategori" method="GET" id="cari">
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Kategori List</h3>
                            </div>
                            <div class="col text-right">
                                <a href="/admin/main_kategori/kategori_add" class="btn btn-sm btn-primary">Tambah Data</a>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach($kategori as $kat)
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        |
                                        <a href="/admin/main_kategori/kategori_delete/{{ $kat->id_kategori }}">Hapus</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
